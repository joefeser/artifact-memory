...
def import_selected_task(task: dict[str, Any], authorized: bool, selected_task_id: str | None = None) -> dict[str, Any]:
    ...
    if not authorized or (selected_task_id is not None and selected_task_id != task_id):
        ...
        return {"records": [], "declassification_receipt": receipt_with_digest("artifact-memory/declassification-receipt/v1", "declassification-receipt://", receipt_body)}
    ...
    return {"records": [record], "declassification_receipt": receipt_with_digest("artifact-memory/declassification-receipt/v1", "declassification-receipt://", receipt_body)}
