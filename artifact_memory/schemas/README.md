...
preparation, pending owner signature, verified signed-tag evidence, pending
post-publication attestation, and publication authority. Released v1/v2 bytes
remain historical evidence. V3 records that keyless attestation is required but
pending until after publication; attestation bundles remain external evidence.
Synthetic examples never represent a real key or tag.
