#!/usr/bin/env python3
"""Run or check the issue #22 exchange conformance fixture."""
...
DEFAULT_FIXTURE = ROOT / "fixtures" / "synthetic" / "exchange" / "v2"
...
def main(argv: list[str] | None = None) -> int:
    return run_conformance_cli(
        ...
        run_fixture=run_exchange_conformance,
        expected_receipt=Path("expected-receipt.json"),
        mismatch_message="exchange conformance receipt does not match checked evidence",
        render_receipt=render_exchange_conformance_receipt,
